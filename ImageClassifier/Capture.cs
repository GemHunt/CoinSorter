...
namespace ImageClassifier
{
    class Camera
    {
        ...
        public static extern IntPtr ClassifyFromWebCam(int imageID, bool show, bool classify, String modelDir);

        [DllImport("E:\\build\\Caffe-prefix\\src\\Caffe-build\\examples\\cpp_classification\\Debug\\classification-d.dll", CallingConvention = CallingConvention.Cdecl)]
        private static extern int ReleaseMemory(IntPtr ptr);

        public static void ClassifyFromWebCam(int imageID, bool show, bool classify, ref int date, ref String design)
        {
            date = 0;
            design = "null";
            String modelDir = "C:/Users/pkrush/Documents/GemHunt/CoinSorter/models";
            IntPtr ptr = ClassifyFromWebCam(imageID, show, classify, modelDir);
