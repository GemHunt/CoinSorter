...
https://github.com/NVIDIA/DIGITS/blob/master/digits/dataset/images/generic/test_lmdb_creator.py
5/5/2015 Paul Krush
...
def create_lmdbs(folder, image_width=None, image_height=None, image_count=None):
    ...
    for phase, image_count in [
        ...
        for i in range(0,359):
            file_name = '/home/pkrush/HeadsWithRotation5/' + str(i).zfill(3) + '10005199.jpg'
            ...
            label_datum.float_data.extend(np.array([i]).flat)
